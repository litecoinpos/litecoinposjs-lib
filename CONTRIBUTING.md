...
Firstly in terms of structure, there is no particular concept of "litecoinposjs developers" in a sense of privileged people.
...
* litecoinposjs.slack.com
* #litecoinposjs-dev on Freenode IRC
...
To contribute a patch, the workflow is as follows:
  ...
  1. Submit a pull request to https://github.com/litecoinposjs/litecoinposjs-lib
...
- `litecoinposjs.script.decompile` is consensus bound only,  it does not reject based on policy.
- `litecoinposjs.script.compile` will try to adhere to bitcoin-core `IsStandard` policies rules. (eg. minimalpush in https://github.com/litecoinposjs/litecoinposjs-lib/pull/638)
